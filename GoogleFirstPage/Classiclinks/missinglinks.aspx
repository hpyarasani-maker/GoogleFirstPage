<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="missinglinks.aspx.cs" Inherits="GoogleFirstPage.Classiclinks.missinglinks" Title="SERP - Missing Classic Links" %>
        ...
        <div class="containerDB">
            <div class="header3">
                <div style="margin-top: 12px;">
                 ...
                 <asp:TextBox ID="txtmsgsearch" runat="server" Height="30px" Width="300px" CssClass="text1" OnTextChanged="txtmsgsearch_TextChanged" AutoPostBack="false" placeholder="Search a keyword"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="req1" runat="server" ErrorMessage="*" ControlToValidate="txtmsgsearch" Text="*"></asp:RequiredFieldValidator>
                   ...
                   <asp:DropDownList ID="ddlseid" CssClass="text1" Height="30px" Width="300px" runat="server">
                    ...
                    &nbsp;
                <asp:Button runat="server" Text="Submit" CssClass="btnlf" Height="27px" ID="btnmsg" Width="120px" OnClick="btnmsg_Click" />
                    <br />
                    <br />
                    <br />
                </div>
            ...
            <br />
            <br />
            <asp:Label ID="Label1" runat="server" ForeColor="Blue" Font-Size="Large" Font-Bold="true" Text="Missing Classic Links"></asp:Label><br />
            <br />
            <br />
            <br />
            <br />
            ...
            <%--<div id="oxydiv1" runat="server">
                <table border="1" style="width: 800px">
                    ...
                    <tr>
                        <td><b>Missing Classic Links</b> </td>
                        <td>
            ...
            <div class="wrapper">
                ...
                <br />
                <br />
                <asp:GridView ID="gridviewmsg" AutoGenerateColumns="true" CssClass="footable" HeaderStyle-HorizontalAlign="Right" Font-Bold="true" HeaderStyle-Font-Bold="true" runat="server" OnRowDataBound="gridviewmsg_RowDataBound" RowStyle-Height="1px" AlternatingRowStyle-BackColor="#f5f5f5" Font-Size="Small" HeaderStyle-BackColor="#e4e8ef" HeaderStyle-Height="30px" RowStyle-Width="1px">
                    <%--<Columns>
            ...
            <br />
            <br />
            <asp:Label ID="lblclcnt" runat="server" CssClass="LblClass"></asp:Label>
            <br />
            <br />
            <div id="footer">
                <div style="font-weight: bold; font-size: 14px;">© <%= DateTime.Now.Year %> Pi Datametrics | SERP - Missing Classic Links.</div>
            </div>
        </div>
    </form>
</body>

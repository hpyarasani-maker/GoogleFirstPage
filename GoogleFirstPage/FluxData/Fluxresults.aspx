<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fluxresults.aspx.cs" Inherits="GoogleFirstPage.FluxData.Fluxresults" Title="Flux Results" %>
                            ...
                            <div class="navigation">
                                <nav style="margin-left: 950px; margin-top: 10px">
                                    <ul class="nav topnav bold">
                                        <li class="dropdown">
                                            <a href="../Dashboard.aspx">Flux Results</a>&nbsp;<ul style="display: none;" class="dropdown-menu bold">
        ...
        <div class="containerDB">
            <div class="header3">
                ...
                <strong><span class="auto-style2">Search Engine :</span></strong>&nbsp;&nbsp; 
                          <asp:DropDownList ID="SEList" runat="server" Width="300px" CssClass="text1" Height="30px">
                          </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" Text="*" ControlToValidate="SEList" InitialValue="----Select----"></asp:RequiredFieldValidator>
                &nbsp;&nbsp;
                <strong><span class="auto-style2">Flux Average Movement :</span></strong>&nbsp;&nbsp; 
                <asp:DropDownList ID="ddlfluxaverage" runat="server" Width="50px" CssClass="text1" Height="30px">
                ...
                <strong><span class="auto-style1">Date :</span></strong>&nbsp;&nbsp;
                ...
                <asp:Button runat="server" Text="Submit" CssClass="btnlf" Height="27px" ID="btnfluxresults" Width="120px" OnClick="btnfluxresults_Click"/>
                 <%--<div style="margin-left:1150px;margin-top:-30px;">
                <asp:ImageButton ID="dwndcsvfluxresults" runat="server" ImageUrl="~/images/excel.png" CssClass="imgcsvdownloadNew1" ToolTip="Generate Excel" OnClick="dwndcsvfluxresults_Click" />--%>
              <%--  </div>--%>
            </div>
            ...
            <br />
            <div class="wrapper">
                <asp:Label ID="lblalllinks" runat="server" Font-Size="12" ForeColor="Red" Font-Bold="true"></asp:Label>
                <asp:GridView ID="gvflux" runat="server" AutoGenerateColumns="false" CssClass="table table-condensed table-striped table-bordered" Font-Size="Small"  GridLines="Vertical" BackColor="White" HeaderStyle-BackColor="SlateBlue" HeaderStyle-ForeColor="#660033"  OnRowDataBound="gvflux_RowDataBound" OnPageIndexChanging="gvflux_PageIndexChanging" AllowPaging="true" PageSize="200" HeaderStyle-Height="30px">
            ...
            <br />
            <div id="footer">
                <div style="font-weight: bold; font-size: 14px;font-family:Calibri;">© <%= DateTime.Now.Year %> Pi Datametrics | Flux Results.</div>
            </div>
        </div>
    </form>
</body>

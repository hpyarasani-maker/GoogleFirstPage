        ...
        private void Show(string curDate)
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    st += "<p /><table width=\"50%\" bordercolor=\"Blue\" cellpadding=\"0\" cellspacing=\"0\" border=\"1\" style=\"font-family:Verdana, Geneva, sans-serif; font-size:12px;word-wrap:break-word\">";

        ...
        <div class="containerDB">
            <div class="header3">
                <div style="margin-top: 12px;">
                   ...
                   <asp:DropDownList ID="ddltype" CssClass="text1" Height="30px" Width="150px" runat="server">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" Text="*" ControlToValidate="ddltype" InitialValue="----Select----"></asp:RequiredFieldValidator>
                    &nbsp;
                <asp:Button runat="server" Text="Submit" CssClass="btnlf" Height="27px" ID="btnelementslist" Width="120px" OnClick="btnelementslist_Click" />
                    <br />
                    <br />
                    <br />
                </div>
            ...
            <div class="wrapper">
                ...
                <asp:GridView ID="gvelements" Width="100%" AutoGenerateColumns="false" CssClass="footable" RowStyle-CssClass="GvGrid" HeaderStyle-HorizontalAlign="Left" Font-Bold="true" HeaderStyle-Font-Bold="true" runat="server" OnRowDataBound="gvelements_RowDataBound" RowStyle-Height="1px" AlternatingRowStyle-BackColor="#f5f5f5" Font-Size="Small" HeaderStyle-BackColor="#e4e8ef" HeaderStyle-Height="30px" RowStyle-Width="1px" AllowPaging="true" OnPageIndexChanging="gvelements_PageIndexChanging" PageSize="30">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Ai Overview">
                            <ItemTemplate>
                                <div style="width: 68px;">
                        ...
                        <asp:TemplateField HeaderText="ClassiclinkCarousel">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="ClassiclinkSiteLinks">
                            <ItemTemplate>
                                <div style="width: 105px;">
                        ...
                        <asp:TemplateField HeaderText="people Also Search">
                            <ItemTemplate>
                                <div style="width: 105px;">
                        ...
                        <asp:TemplateField HeaderText="Sites Carousel">
                            <ItemTemplate>
                                <div style="width: 90px;">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Missingelementlist.aspx.cs" Inherits="GoogleFirstPage.RapidTrackingSERPs.Missingelementlist" Title="Missingelementslist" %>
...
<head runat="server">
    ...
    <title>SERP Missingelementslist</title>
        ...
        <div class="containerDB">
            <div class="header3">
                <div style="margin-top: 12px;">
                   ...
                   <asp:DropDownList ID="ddlse" CssClass="text1" Height="30px" Width="150px" runat="server">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" Text="*" ControlToValidate="ddlse" InitialValue="----Select----"></asp:RequiredFieldValidator>
                    &nbsp;
                    <span class="auto-style1">Date :</span>&nbsp;&nbsp;
                             <asp:TextBox ID="txtDate" runat="server" placeholder="Date" CssClass="text1" Height="30px" Width="82px"></asp:TextBox>
                ...
                <asp:Button runat="server" Text="Submit" CssClass="btnlf" Height="27px" ID="btnmisselementslist" Width="120px" OnClick="btnmisselementslist_Click" />
                    <br />
                    <br />
                    <br />
                </div>
            ...
            <div class="wrapper">
                ...
                <asp:GridView ID="gvmissingelements" Width="100%" AutoGenerateColumns="false" CssClass="footable" HeaderStyle-HorizontalAlign="Right" Font-Bold="true" HeaderStyle-Font-Bold="true" runat="server" OnRowDataBound="gvmissingelements_RowDataBound" RowStyle-Height="1px" AlternatingRowStyle-BackColor="#f5f5f5" Font-Size="Small" HeaderStyle-BackColor="#e4e8ef" HeaderStyle-Height="30px" RowStyle-Width="1px" AllowPaging="true" OnPageIndexChanging="gvmissingelements_PageIndexChanging" PageSize="30">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Knowledge panel">
                            <ItemTemplate>
                                <div style="width: 90px;">
                                    <%# Eval("Knowledge panel","{0:N0}") %>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Product listed ads">
                            <ItemTemplate>
                                <div style="width: 100px;">
                                    <%# Eval("Product listed ads","{0:N0}") %>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Sports results">
                            <ItemTemplate>
                                <div style="width: 80px;">
                                    <%# Eval("Sports results","{0:N0}") %>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Site links">
                            <ItemTemplate>
                                <div style="width: 60px;">
                                    <%# Eval("Site links","{0:N0}") %>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Text ads">
                            <ItemTemplate>
                                <div style="width: 60px;">
                                    <%# Eval("Text ads","{0:N0}") %>
                                </div>
                        ...
                        <asp:TemplateField HeaderText="Video carousel">
                            <ItemTemplate>
                                <div style="width: 80px;">
                                    <%# Eval("Video carousel","{0:N0}") %>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <br />
            <div id="footer">
                <div style="font-weight: bold; font-size: 14px;">© <%= DateTime.Now.Year %> Pi Datametrics | SERP ElementsList.</div>
            </div>
        </div>
    </form>
</body>

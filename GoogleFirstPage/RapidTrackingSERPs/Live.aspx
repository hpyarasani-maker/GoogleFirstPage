    ...
    <form id="form1" runat="server">
        ...
        <div class="containerDB">
            ...
            <div class="wrapper">
                ...
                <br />
                <br />
                <asp:GridView ID="gridviewlive" AutoGenerateColumns="false" CssClass="footable" RowStyle-CssClass="GvGrid" HeaderStyle-HorizontalAlign="Left" Font-Bold="true" HeaderStyle-Font-Bold="true" runat="server" OnRowDataBound="gridviewlive_RowDataBound" RowStyle-Height="1px" AlternatingRowStyle-BackColor="#f5f5f5" Font-Size="Small" HeaderStyle-BackColor="#e4e8ef" HeaderStyle-Height="30px" RowStyle-Width="1px">
                    <Columns>

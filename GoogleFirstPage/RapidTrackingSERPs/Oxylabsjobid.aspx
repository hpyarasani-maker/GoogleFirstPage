<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Oxylabsjobid.aspx.cs" Inherits="GoogleFirstPage.RapidTrackingSERPs.Oxylabsjobid" Title="Oxylabs JobID" %>
        ...
        <div class="containerDB">
            <div class="header3">
                <div style="margin-top: 12px;">
                 ...
                 <asp:TextBox ID="txtjobid" runat="server" Height="27px" Width="250px" CssClass="text1" AutoPostBack="false" placeholder="Jobid is Required"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="req1" runat="server" ErrorMessage="*" ControlToValidate="txtjobid" Text="*"></asp:RequiredFieldValidator>
                 &nbsp; <strong><span class="auto-style2">Search Engine :</span></strong>&nbsp;&nbsp; 
                   <asp:DropDownList ID="ddlseids" CssClass="text1" Height="27px" Width="280px" runat="server">
                   </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" Text="*" ControlToValidate="ddlseids" InitialValue="----Select----"></asp:RequiredFieldValidator>
                &nbsp;
                <asp:Button runat="server" Text="Download" CssClass="btnlf" Height="27px" ID="btndata" Width="120px" OnClick="btndata_Click" />
                <br />
                <br />
                <br />
            </div>
            ...
            <div id="footer">
                ...
                <div style="font-weight: bold; font-size: 14px;">© <%= DateTime.Now.Year %> Pi Datametrics | Oxylabs JobID.</div>
            </div>
        </div>
    </form>
</body>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="keywordsearch.aspx.cs" Inherits="GoogleFirstPage.RapidTrackingSERPs.keywords" Title="Tracking Jobids and keywords" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Tracking Jobids and keywords</title>
        ...
        <div class="containerDB">
            <div class="header3">
                <div style="margin-top: 12px;">
                    <asp:Button runat="server" Text="Get Keywords" CssClass="btnlf" Height="27px" ID="btnsearchkwd" Width="120px" OnClick="btnsearchkwd_Click" />
                </div>
            </div>
            <div class="wrapper">
                <br />
            ...
            <br />
            <div id="footer">
                <div style="font-weight: bold; font-size: 14px;">© <%= DateTime.Now.Year %> Pi Datametrics | SERP - Keywordsearch.</div>
            </div>
        </div>
    </form>
</body>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetSimilarkeywords.aspx.cs" Async="true" Title="Get Similar Keywords" AsyncTimeout="100000" Inherits="GoogleFirstPage.DataDiscoveryTools.GetSimilarkeywords" %>
...
<head runat="server">
    ...
    <title>Get Similar Keywords</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="containerDB">
            ...
            <div style="margin-left: 670px;">
                <p style="font-family: Cambria; color: black; font-size: 25px; font-weight: bold;"><u> Get Similar Keywords </u> </p>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="margin-left: 120px;">
                                    <asp:Button ID="btngetsimilarkeywords" runat="server" Text="Submit" OnClick="btngetsimilarkeywords_Click" CssClass="btnlf" Height="27px" Width="120px" />
                                </div>
                            </td>
                        </tr>
                        <tr>
            ...
            <br />
            <div id="footer">
                <div style="font-weight: bold; font-size: 14px;font-family:Calibri;">© <%= DateTime.Now.Year %> Pi Datametrics | Get similar keywords.</div>
            </div>

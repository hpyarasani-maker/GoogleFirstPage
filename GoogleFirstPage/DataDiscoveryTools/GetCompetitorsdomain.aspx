<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetCompetitorsdomain.aspx.cs" Async="true" AsyncTimeout="100000" Title="Get Competitors Domain" Inherits="GoogleFirstPage.DataDiscoveryTools.GetCompetitorsdomain" %>
...
<head runat="server">
    ...
    <title>Get Competitors Domain</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="containerDB">
            ...
            <div style="margin-left: 600px;">
                <p style="font-family: Cambria; color: black; font-size: 25px; font-weight: bold;"><u> Get Competitors Domain </u> </p>
            </div>
                    ...
                    <table class="auto-style1" border="0">
                        ...
                        <tr style="border-top: solid 2px black; border-bottom: solid 2px black; border-left: solid 2px black; border-right: solid 2px black;">
                            ...
                            <td>
                                ...
                                <asp:RangeValidator ID="myrange" runat="server" ControlToValidate="txtlimit" MaximumValue="1000" MinimumValue="100" ValidationGroup="temp" SetFocusOnError="True" Type="Double" Display="Dynamic" ForeColor="Red"></asp:RangeValidator>
                            </td>
                        </tr>
                        ...
                        <tr style="border-top: solid 2px black; border-bottom: solid 2px black; border-left: solid 2px black; border-right: solid 2px black;">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlorderby" runat="server" Width="160px" CssClass="text1" AppendDataBoundItems="true">
                                    ...
                                    <asp:ListItem Text="Intersections" Value="intersections" />
                                    <asp:ListItem Text="Pos_sum" Value="pos_sum" />
                                    <asp:ListItem Text="Avg_pos" Value="avg_pos" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="margin-left: 0px;">
                                    <asp:Button ID="btngetcompetitors" runat="server" Text="Submit" OnClick="btngetcompetitors_Click" CssClass="btnlf" Height="27px" Width="120px" />
                                </div>
                            </td>
                        </tr>
                        <tr>
            ...
            <br />
            <div id="footer">
                <%--<div style="font-weight: bold; font-size: 14px;">© 2020 Pi Datametrics | Get Competitors Domain</div>--%>
                <div style="font-weight: bold; font-size: 14px;font-family:Calibri;">© <%= DateTime.Now.Year %> Pi Datametrics | Get Competitors Domain.</div>
            </div>

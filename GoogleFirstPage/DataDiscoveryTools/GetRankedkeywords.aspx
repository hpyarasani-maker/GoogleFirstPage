<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetRankedkeywords.aspx.cs" Async="true" AsyncTimeout="100000" Title="Get Ranked Keywords" Inherits="GoogleFirstPage.DataDiscoveryTools.GetRankedkeywords" %>
...
<head runat="server">
    ...
    <title>Get Ranked Keywords</title>
    ...
    <script type="text/javascript">
        function CheckBoxValidation(oSrouce, args) {
            var myCheckBox = document.getElementById('<%= chkpositionhigherthan.ClientID %>');
            var myTextBox = document.getElementById('<%= txtpostionhigerthan.ClientID %>');
        ...
        function CheckBoxValidation1(oSrouce, args) {
            var myCheckBox1 = document.getElementById('<%= chkpositionlowerthan.ClientID %>');
            var myTextBox1 = document.getElementById('<%= txtpostionlowerthan.ClientID %>');
    ...
    <form id="form1" runat="server">
        ...
        <div class="containerDB">
            ...
            <div style="margin-left: 600px;">
                <p style="font-family: Cambria; color: black; font-size: 25px; font-weight: bold;"><u> Get Ranked Keywords </u> </p>
            </div>
                ...
                <div style="margin-left: 300px;">
                    <table class="auto-style1" border="0">
                        ...
                        <tr style="border-bottom: solid 2px black; border-top: solid 2px solid; border-left: solid 2px black; border-right: solid 2px black;">
                            ...
                            <td>
                                <asp:DropDownList ID="ddltype" runat="server" Width="160px" CssClass="text1" AppendDataBoundItems="true">
                        ...
                        <tr style="border-top: solid 2px black; border-bottom: solid 2px black; border-left: solid 2px black; border-right: solid 2px black;">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlorderby" runat="server" Width="160px" CssClass="text1" AppendDataBoundItems="true">
                                    ...
                                    <asp:ListItem Text="Result count" Value="results_count"></asp:ListItem>
                                    <asp:ListItem Text="Etv" Value="etv"></asp:ListItem>
                                    <asp:ListItem Text="Traffic cost" Value="traffic_cost"></asp:ListItem>
                                    <asp:ListItem Text="competition" Value="competition"></asp:ListItem>
                                    <asp:ListItem Text="CPC" Value="cpc"></asp:ListItem>
                                    <asp:ListItem Text="search_volume" Value="search_volume"></asp:ListItem>
                                </asp:DropDownList>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:RadioButton ID="rb2orderby" runat="server" Text="Desc" GroupName="a1" />&nbsp;&nbsp;&nbsp;
                        ...
                        <tr style="border-top: solid 2px black; border-left: solid 2px black; border-right: solid 2px black;">
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="chkpositionhigherthan" runat="server" Text="Position Higher than :" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtpostionhigerthan" runat="server" CssClass="text1"></asp:TextBox>
                                <asp:CustomValidator ID="Custom1" ClientValidationFunction="CheckBoxValidation" runat="server" ErrorMessage="Enter position higher value" SetFocusOnError="true"></asp:CustomValidator>
                        ...
                        <tr style="border-left: solid 2px black; border-right: solid 2px black;">
                            ...
                            <td>
                                ...
                                <asp:CheckBox ID="chkpositionlowerthan" runat="server" Text="Position Lower than :" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtpostionlowerthan" runat="server" CssClass="text1"></asp:TextBox>
                                ...
                                <asp:CustomValidator ID="CustomValidator1" ClientValidationFunction="CheckBoxValidation1" runat="server" ErrorMessage="Enter position lower value"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr style="border-top: solid 2px solid; border-left: solid 2px black; border-right: solid 2px black;">
                               <td class="auto-style2">&nbsp;</td>
                            <td>
                                <asp:CheckBox ID="chkcpchigherthan" runat="server" Text="CPC Higher than :" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtcpchigherthan" runat="server" CssClass="text1"></asp:TextBox>
                                <asp:CustomValidator ID="CustomValidator4" ClientValidationFunction="CheckBoxValidation1" runat="server" ErrorMessage="Enter cpc higher value"></asp:CustomValidator>
                            </td>
                        </tr>
                          <tr style="border-left: solid 2px black; border-right: solid 2px black;">
                               <td class="auto-style2">&nbsp;</td>
                            <td>
                                <asp:CheckBox ID="chkcpclowerthan" runat="server" Text="CPC Lower than :" />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="txtcpclowerthan" runat="server" CssClass="text1"></asp:TextBox>
                                <asp:CustomValidator ID="CustomValidator5" ClientValidationFunction="CheckBoxValidation1" runat="server" ErrorMessage="Enter cpc lower value"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr style="border-left: solid 2px black; border-right: solid 2px black;">
                            <td class="auto-style2">&nbsp;</td>
                    ...
                    <asp:TextBox ID="txtsvlowerthan" runat="server" CssClass="text1"></asp:TextBox>
                        ...
                        <tr style="border-left: solid 2px black; border-right: solid 2px black; border-bottom: solid 2px black;">
                            ...
                            <td class="auto-style4">
                                <asp:DropDownList ID="ddlfilter" runat="server" Width="160px" CssClass="text1" AppendDataBoundItems="true">
                                    <asp:ListItem Text="Drop down" Value="0" />
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="margin-left: 120px;">
                                    <asp:Button ID="btngetrankedkeywords" runat="server" Text="Submit" OnClick="btngetrankedkeywords_Click" CssClass="btnlf" Height="27px" Width="120px" />
                                </div>
                            </td>
                        </tr>
                        <tr>
            ...
            <br />
            <div id="footer">
                <%--<div style="font-weight: bold; font-size: 14px;">© 2020 Pi Datametrics | Get Ranked Keywords</div>--%>
                <div style="font-weight: bold; font-size: 14px;font-family:Calibri;">© <%= DateTime.Now.Year %> Pi Datametrics | Get Ranked Keywords.</div>
            </div>

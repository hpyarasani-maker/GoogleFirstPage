<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GetSerpcompetitors.aspx.cs" Async="true" AsyncTimeout="100000" Title="Get SERP Competitors" Inherits="GoogleFirstPage.DataDiscoveryTools.GetSerpcompetitors" %>
...
<head runat="server">
    ...
    <title>Get SERP Competitors</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="containerDB">
            ...
            <div style="margin-left: 580px;">
                <p style="font-family: Cambria; color: black; font-size: 25px; font-weight: bold;"><u> Get SERP Competitors </u> </p>
            </div>
            ...
            <div class="wrapper">
                ...
                <div style="margin-left: 300px;">
                    <table class="auto-style1" border="0">
                        ...
                        <tr style="border-bottom: solid 2px black; border-top: solid 2px solid; border-left: solid 2px black; border-right: solid 2px black;">
                            <td class="auto-style2">
                                <asp:Label ID="Label1" runat="server" Text="Keywords :" Font-Bold="true">
                                </asp:Label>
                                <br />
                                <b style="color: red">(Max = 200)</b>
                            </td>
                            <td class="auto-style2">
                                <asp:TextBox ID="txtkeyword" runat="server" CssClass="text1" Height="181px" TextMode="MultiLine" Width="459px" placeholder="Enter one or more keywords, each on a separate line"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="req1" runat="server" ControlToValidate="txtkeyword" Text="Enter keywords"></asp:RequiredFieldValidator> 
                            </td>
                        </tr>
                        <tr style="border-top: solid 2px black; border-bottom: solid 2px black; border-left: solid 2px black; border-right: solid 2px black;">
                            <td class="auto-style2">
                        ...
                        <tr style="border-top: solid 2px black; border-bottom: solid 2px black; border-left: solid 2px black; border-right: solid 2px black;">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlorderby" runat="server" Width="160px" CssClass="text1" AppendDataBoundItems="true">
                                    ...
                                    <asp:ListItem Enabled="true" Text="Average position" Value="avg_position"></asp:ListItem>
                                    <asp:ListItem Enabled="true" Text="Keyword count" Value="keywords_count"></asp:ListItem>
                                    <asp:ListItem Enabled="true" Text="rating" Value="rating"></asp:ListItem>
                                    <asp:ListItem Enabled="true" Text="Etv" Value="etv"></asp:ListItem>
                                    <asp:ListItem Enabled="true" Text="visibility" Value="visibility"></asp:ListItem>
                                </asp:DropDownList>
                                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="margin-left: 120px;">
                                    <asp:Button ID="btnserpgetcompetitors" runat="server" Text="Submit" OnClick="btnserpgetcompetitors_Click" CssClass="btnlf" Height="27px" Width="120px" />
                                </div>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div>
                        ...
                        <asp:CustomValidator ID="cstsc" runat="server" ForeColor="Red" OnServerValidate="cstsc_ServerValidate" SetFocusOnError="true" ControlToValidate="txtkeyword" Font-Size="Medium" Font-Bold="true"></asp:CustomValidator>
                                <br />
                        <asp:Label ID="lblerror" runat="server" ForeColor="Red" Font-Size="Large"></asp:Label>
                    </div>
                </div>
            ...
            <br />
            <div id="footer">
                <%--<div style="font-weight: bold; font-size: 14px;">© 2020 Pi Datametrics | Get SERP Competitors</div>--%>
                <div style="font-weight: bold; font-size: 14px;font-family:Calibri;">© <%= DateTime.Now.Year %> Pi Datametrics | Get SERP Competitors.</div>
            </div>

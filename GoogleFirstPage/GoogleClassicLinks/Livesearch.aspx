<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Livesearch.aspx.cs" Inherits="GoogleFirstPage.GoogleClassicLinks.Livesearch" Title="Top 100 Classic links" %>
...
<head runat="server">
    ...
    <title>Top 100 Classic links</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="containerDB">
            <div class="header3">
               ...
               <asp:TextBox ID="textsearchbox" runat="server" Height="30px" Width="300px" CssClass="text1" OnTextChanged="textsearchbox_TextChanged" AutoPostBack="false" placeholder="Search a keyword"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="req1" runat="server" ErrorMessage="*" ControlToValidate="textsearchbox" Text="*"></asp:RequiredFieldValidator>
                    &nbsp;&nbsp;
                     <strong><span class="auto-style2">Search Engine :</span></strong>&nbsp;&nbsp; 
                          <asp:DropDownList ID="searchEngines" runat="server" Width="300px" CssClass="text1" Height="30px">
                          </asp:DropDownList>
                    ...
                    &nbsp;&nbsp;
                <asp:Button runat="server" Text="Submit" CssClass="btnlf" Height="25px" ID="btnlivesearch" Width="120px" OnClick="btnlivesearch_Click" />
                </div>
            </div>
            <br />
            <br />
            ...
            <asp:Label ID="Label1" runat="server" ForeColor="Blue" Font-Size="Large" Font-Bold="true" Text="Only Classic Links"></asp:Label><br />
            <br />
            <br />
            ...
            <div class="wrapper">
                ...
                <asp:GridView ID="gvtracking" AutoGenerateColumns="false" CssClass="footable" HeaderStyle-HorizontalAlign="Right" Font-Bold="true" HeaderStyle-Font-Bold="true" runat="server" OnRowDataBound="gvtracking_RowDataBound" RowStyle-Height="20px" AlternatingRowStyle-BackColor="#f5f5f5" Font-Size="Small" HeaderStyle-BackColor="#e4e8ef" HeaderStyle-Height="30px">
                    <Columns>
            ...
            <br />
            <div id="footer">
                <%--<div style="font-weight: bold; font-size: 14px;">© 2020 Pi Datametrics | Top 100 Classic links.</div>--%>
                <div style="font-weight: bold; font-size: 14px;">© <%= DateTime.Now.Year %> Pi Datametrics | Top 100 Classic links.</div>
            </div>

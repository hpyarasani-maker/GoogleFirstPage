...
new SearchProperties()
           ...
           new SearchProperties()
           {
                seid = 712, domain ="st", geo_location="Sao Tome and Príncipe", locale= "pt-st", uule = "w+CAIQICIVU2FvIFRvbWUgYW5kIFByaW5jaXBl",device="desktop"
           },
           new SearchProperties()
           {
                seid = 713, domain ="st", geo_location="Sao Tome and Príncipe", locale= "pt-st", uule = "w+CAIQICIVU2FvIFRvbWUgYW5kIFByaW5jaXBl",device="mobile_android"

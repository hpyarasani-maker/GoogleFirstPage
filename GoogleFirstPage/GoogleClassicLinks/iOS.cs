    ...
    public class iOS
    {
        ...
        private string ProcessOrganic(HtmlNode node)
        {
            ...
            else
            {
                ...
                if (nds == null)
                    nds = node.SelectNodes(".//div[@class='setTDc']|.//div[contains(@class, 'P8ujBc v5yQqb')]|.//div[@class='WFyfFf yOwOKc']|.//div[@class='kb0PBd cvP2Ce jGGQ5e']");//14-02-2024
        ...
        private bool IsBlock(HtmlNode node)
        {
            ...
            nd = node.SelectSingleNode(".//div[@class='KJDcUb WzRKRb']|.//div[contains(@class,'P8ujBc')]" +
             ...
             "|.//div[contains(@class,'EtOod pkphOe')]|.//div[@class='mnr-c Eiw3V']|.//div[contains(@class, 'WFyfFf')]|.//div[@class='kb0PBd cvP2Ce jGGQ5e']");//14-02-2024//23-08-2023//17-05-2023//26-09-2022 //29-06-2022
        ...
        private bool IsOrganic(HtmlNode node)
        {
            return (node.HasClass("srg") || node.SelectSingleNode(".//div[@class='oITGTd aSYQ6c']") != null
                ...
                "|.//div[@class='T61Aje v5yQqb']|.//div[contains(@class, 'WFyfFf')]") != null || node.SelectSingleNode(".//div[@class='kb0PBd cvP2Ce jGGQ5e']") != null;//14-02-2024//23-08-2023 != null//17-05-2023 //31-05-2022
        }

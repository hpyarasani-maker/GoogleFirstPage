    ...
    public class Desktop
    {
        ...
        private string ProcessOrganic(HtmlNode node)
        {
            ...
            else
            {
                ...
                {
                    nc = node.SelectNodes(".//div[@class='g']|.//div[contains(@class,'g Ww4FFb')]|.//div[@class='g eejeod up9jud']|.//div[contains(@class,'g dFd2Tb')]|.//div[@class='wHYlTd Ww4FFb vt6azd tF2Cxc asEBEc']" +
